...
# Sounds
move_sound = pg.mixer.Sound("Sounds/move.ogg")
illegal_sound = pg.mixer.Sound("Sounds/illegal.ogg")
check_sound = pg.mixer.Sound("Sounds/check.ogg")
capture_sound = pg.mixer.Sound("Sounds/capture.ogg")
castle_sound = pg.mixer.Sound("Sounds/castle.ogg")
promote_sound = pg.mixer.Sound("Sounds/promote.ogg")
start_sound = pg.mixer.Sound("Sounds/start.ogg")
end_sound = pg.mixer.Sound("Sounds/end.ogg")
low_time_sound = pg.mixer.Sound("Sounds/tenseconds.ogg")